...
################ THIS IS JUST TO SHOW HOW THE SAMPLING PROCESS WORKS - THE LINECHART_PRICECHANGE.PY IS THE CORRECT USE TO PRODUCE THE LINE CHART ###############
...
pricenew[['price']] = pricenew[['price']].ffill()
